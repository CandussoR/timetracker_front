                ...
                <div>
                    <div class="datepicker">
                        ...
                        <VueDatePicker v-if="selectedCriteria.includes('month')" 
                            ...
                            preventMinMaxNavigation :year-range="[minDate.getFullYear(), maxDate]" placeholder="Select a month" />
                        <VueDatePicker v-if="selectedCriteria.includes('year')" id="year" v-model="year"
                            :year-range="[minDate.getFullYear(), maxDate]" year-picker auto-apply preventMinMaxNavigation
